...
(function (global, factory) {
  ...
  var TEMPLATE = '<div class="cropper-container" touch-action="none">' + 
                    ...
                    '<div class="cropper-crop-box" style="position: relative;">' +
                      '<span class="cropper-view-box"></span>' + 
                      '<img src="/static/assets/img/marco6.png" style="position: absolute;top:0px;"/>' +
                      ...
                      '<div class="label-rut"><div id="rutpreview" class="center-rut"></div></div>' + 
                    '</div>' + 
                  '</div>';
